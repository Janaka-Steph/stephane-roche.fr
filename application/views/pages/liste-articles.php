		...
		<span class="meta_art_date"><em>Posté
                ...
                <footer class="footer-article row full-width">
                    ...
                    <a class="suitelink" href="<?php base_url(); ?>blog/article/<?php echo $row->art_url_rw; ?>">
                        <svg version="1.1" class="suite-img right" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             width="38px" height="20px" viewBox="0 0 38 20" enable-background="new 0 0 38 20"
                             xml:space="preserve" fill="#C1272D">
			...
			C1.132,5.65,7.46,4.491,8.667,4.491z"/>
                            <text transform="matrix(0.9989 0 0 1 11.6377 19.7559)" font-family="'Courgette-Regular'"
                                  font-size="7.7355">Suite
                            </text>
			</svg>
                    </a>
                </footer>
